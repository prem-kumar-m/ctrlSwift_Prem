...
export const reqloadreguser = (state) => ({
  type: Constants.REQ_LOAD_REG_USER_DATA,
  url: Constants.API_URLS.LOAD_REG_USER_URL,
  state,
});

export const recloadreguser = (reglist) => ({
  type: Constants.REC_LOAD_REG_USER_DATA,
  reglist,
});

export const requestloadallData = (year) => (
console.log("action :"+year),
    {
      type: Constants.REQUEST_LOAD_ADMIN_PLAN_DETAILS,
      url: Constants.API_URLS.LOAD_ADMIN_PLAN_DETAILS,
      year,
    }
  );

  export const reciveloadallData = (loadplan) => ((console.log(loadplan)),{
    type: Constants.RECEIVE_LOAD_ADMIN_PLAN_DETAILS,
    loadplan,
  });
