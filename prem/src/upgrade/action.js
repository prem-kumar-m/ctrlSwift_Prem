...
export const requestloadtimezone = (timezone) => ({
  type: Constants.UPGRADE_REQUEST_LOAD_TIMEZONE_LIST_DATA,
  url: Constants.API_URLS.CUSTOMIZE_LIST_TIMEZONE_URL,
  timezone,
});

export const receiveloadtimezonelist = (timezonelist) => ({
  type: Constants.UPGRADE_RECEIVE_LOAD_TIMEZONE_LIST_DATA,
  timezonelist,
});
...
export const requestEnterpriseClaculatePriceupgread = (data) => ({
  type: Constants.REQUEST_ENTERPRISE_CALCULATE_PRICE,
  url: Constants.API_URLS.ENTERPRISE_CALCULATE_PRICE_URL,
  data,
});

export const responcesEnterpriseClaculatePriceupgread = (enterpriseRecommended) => ({
...
export const requestClaculatePrice = (data) => ({
  type: Constants.REQUEST_FINAL_CALCULATE_PRICE,
  url: Constants.API_URLS.UPGRADE_AND_DOWNGRADE_CHECK,
  data,
});

export const responcesClaculatePrice = (recommendedPrice) => ({
  type: Constants.RECEIVE_FINAL_CALCULATE_PRICE,
  recommendedPrice,
});

export const checkStatus = (data) => ({
  type: Constants.REQUEST_CHECKSTATUS,
  url: Constants.API_URLS.UPGRADE_AND_DOWNGRADE_CHECK,
  data,
});

export const responcesCheckStatus = (recivedcheckStatus) => ({
  type: Constants.RECEIVE_CHECKSTATUS,
  recivedcheckStatus,
});
