...
class PayPerUse extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6 single-price">
                ...
                <div className="bottom-part">
                  <h1 style={{ fontSize: "4em", fontWeight: 300 }}>500$</h1>
                  <p>Per Year</p>
                  <br></br>
              ...
              <div className="col-lg-4 col-md-6 single-price">
                <div className="top-part">
                  ...
                  <br></br>
                  <h2>PPU -Enterprise</h2>
                </div>
                <div className="package-list"></div>
                <div className="bottom-part">
                  <h1 style={{ fontSize: "4em", fontWeight: 300 }}>1000$</h1>
                  <p>Per Year</p>
                  <br></br>
              ...
              <div className="col-lg-4 col-md-6 single-price">
                ...
                <div className="package-list"></div>
                <div className="bottom-part">
                  <h1 style={{ fontSize: "4em", fontWeight: 300 }}>5000$</h1>
                  <p>Per Year</p>
                  <br></br>
