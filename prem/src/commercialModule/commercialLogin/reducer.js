...
export default (
  ...
  switch (type) {
    case Constants.COMMERCIAL_RECEIVE_LOAD_DISTRICT_DATA: {
    ...
    case Constants.COMMERCIAL_LOGIN_PAGE_RESPONSE: {
    ...
    case Constants.COMMERCIAL_LOGIN_RESEND_OTP_RESPONSE: {
    ...
    case Constants.COMMERCIAL_RESPONCES_OTP_LOGIN: {
      console.log(
        "======================isOtpSuccess\n==================" +
    ...
    case Constants.COMMERCIAL_RECEIVE_FORGOTPASSWORD: {
      const statenew = { ...state };
      statenew.forgotEmail = forgotEmail;
      return statenew;
    }

    case Constants.COMMERCIAL_FORGOTPASSWORD_RESPONSE: {
      const statenew = { ...state };
      statenew.isVerifySuccess = isVerifySuccess;
      return statenew;
    }

    case Constants.COMMERCIAL_FORGOTPASSWORD_VERIFY_OTP_RESPONSE: {
      const statenew = { ...state };
      statenew.isValidatdOtpSuccess = isValidatdOtpSuccess;
      return statenew;
    }

    case Constants.COMMERCIAL_RESENDOTP_RESPONSE: {
    ...
    case Constants.COMMERCIAL_NEWPASSWORD_RESPONSE: {
