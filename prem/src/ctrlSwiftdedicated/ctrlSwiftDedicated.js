...
class ctrlSwiftDedicated extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
                  ...
                  >
                    <span>
                      {this.state.toggle ? (
                        <span>
                          {" "}
                          <s style={{ color: "#8bc34a" }}>1600$</s> 1520$
                        </span>
                      ) : (
                        "1600$"
                      )}
                  ...
                  >
                    <span>
                      {this.state.toggle ? (
                        <span>
                          {" "}
                          <s style={{ color: "#8bc34a" }}>2080$</s> 2197$
                        </span>
                      ) : (
                        "2080$"
                      )}
                  ...
                  >
                    <span>
                      {this.state.toggle ? (
                        <span>
                          {" "}
                          <s style={{ color: "#8bc34a" }}>3200$</s> 3040$
                        </span>
                      ) : (
                        "3200$"
                      )}
...
export default ctrlSwiftDedicated;
