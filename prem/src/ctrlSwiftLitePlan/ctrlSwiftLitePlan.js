...
import { requestPlanPrice } from "./action";


class ctrlSwiftLitePlan extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      plan: "Lite",
...
console.log("-----testing")
  ...
  //  console.log(JSON.stringify( this.props.isSuccess.dynamicPriceList));
    ...
    return (
      <div>
        ...
        <div className="view">
          ...
          <section className="generic-banner relative banner-area-inner10">
        ...
        <section className="price-area section-gap" id="schedule">
          <div className="container">
            ...
            <div className="row justify-content-center">
              {this.props.isSuccess  && this.props.isSuccess.dynamicPriceList.map((users, index) => (
                      ...
                      <span>
                        {this.state.toggle ?
                          <span>
                            ...
                            <s style={{ color: "#8bc34a" }}> {users.selectModelPrice}</s>$

                            <br />{users.discountAmount}$
...
export default connect(mapStateToProps, mapDispatchToProps)(ctrlSwiftLitePlan);;
