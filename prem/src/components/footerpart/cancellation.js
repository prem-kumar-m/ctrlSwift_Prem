    ...
    return (
      <div>
        ...
        <section style={{ marginTop: "100px" }}>
          <div className="container" id="cancellation">
            <header>
            ...
            <div>
              <h5 className="headCont">
                ...
                REPRESENT (hereinafter “You” or “Your”) AND BALBAHAS(hereinafter
                “ BALBAHAS”) GOVERNING YOUR USE OF BALBAHAS
              </h5>
            </div>
            <br></br>
            ...
            <div>
              ...
              <p className="termsPara">
                ...
                General Terms and do not agree to any Service Specific Terms, do
                not use the corresponding Service. You can accept the Terms by
            ...
            <div>
              ...
              <p className="termsPara">
                ...
                obtaining access to the Internet and the equipment necessary to
                use the Services. You can create and edit content with your user
                account and if you choose to do so, you can publish and share
                such content.
              </p>
            </div>
          </div>
          <div className="top-button" id="top-page" href="#cancellation">
            <p>
              {" "}
              <a href="#cancellation">
                <span>&#8250;</span>
