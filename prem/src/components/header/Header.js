...
import {
  forgotOtpCustomer, newPasswordCustomer, resendOtpCustomer, verifyCredentialCustomer, verifyEmailCustomer
} from "./action";
import "./Header.scss";
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (this.props.isLoginSuccess !== prevProps.isLoginSuccess) {
      ...
      if (this.state.submitted && this.props.isLoginSuccess.success) {
        ...
        window.sessionStorage.setItem(
          Constants.ACCESS_EMAIL_ID,
          this.props.isLoginSuccess.adminId
        );
        
        window.sessionStorage.setItem(
          Constants.CURRENCY_CODE,
          this.props.isLoginSuccess.currencyCode
        );
        window.sessionStorage.setItem(
        ...
        console.log(window.sessionStorage.getItem(Constants.CURRENCY_CODE));
            ...
            >
              ...
              <Row className="justify-content-md-center">
                <Col className="text-center">
                  ...
                  <Link onClick={this.forgotModal} to="#"> Forgot password?</Link>
