...
//   }
//   );
export const createOrderDataTer = (data) => ({
  type: Constants.CREATE_ORDER_ID_TER, //this will match with your saga
  url: Constants.API_URLS.CREATE_ORDER_ID_TERMINATION_URL,
  data,
});

export const responseCreateOrderDataTer = (createOrderIdTer) => ({
  type: Constants.RESPONSE_CREATE_ORDER_ID_TER,
  createOrderIdTer,
});
export const paymentSuccessTer = (responces) => ({
  type: Constants.CREATE_INVOICES_PAYMENT_TERMINATION_REQUEST, //this will match with your saga
  url: Constants.API_URLS.CREATE_INVOICES_PAYMENT_TERMINATION_URL,
  responces,
});

export const responsePaymentSuccessTer = (paymentStausTer) => ({
  type: Constants.CREATE_INVOICES_PAYMENT_TERMINATION_RESPONCES,
  paymentStausTer,
});
