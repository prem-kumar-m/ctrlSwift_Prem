...
export default (
  ...
  switch (type) {
    ...
    case Constants.ALL_USERS_RESPONSE: {
      const statenew = { ...state };
      statenew.users = users;
      return statenew;
    }
    case Constants.ADD_USER_RESPONSE: {
    ...
    case Constants.DELETE_USER_RESPONSE: {
      console.log("Delete User Success in reducer....... " + isSuccess);
      const statenew = { ...state };
      statenew.isSuccess = isSuccess;
      return statenew;
    }
