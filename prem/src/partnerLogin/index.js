...
import {
  forgotResendOtp,
  newPasswordData, partnerOtpVerify, partnerResendOtp, verifyForgotOtp, verifyPartnerForgot, verifyPartnerLogin
} from "./action";
...
class partnerLogin extends React.Component {
  ...
  handleSubmit = (event) => {
    ...
    if (
      ...
      this.props.verifyPartnerLogin(email, password);
  ...
  resendotp = () => {
    ...
    //this.setState({submitted : true});
    if (this.state.email) {
      this.props.partnerResendOtps(this.state.email);
    }
  };
  otpVer = () => {
    this.setState({
  ...
  render() {
    ...
    return (
      <div className="partnerLogincontainer" style={{ paddingLeft: "0px" }}>
        <div size={10}>
          <div>
            <div
        ...
        >
          <Modal.Header closeButton>
            <span>Select your mode of partnership</span>
          </Modal.Header>
          ...
          <Modal.Body>
            <Form.Group>
              <Row>
                <Col>
                  <Button onClick={this.handleMove}>Company Partnership</Button>
                </Col>
                <Col>
...
const mapStateToProps = (state) => {
  return {
    // login side----------
    isLoginSuccess: state.partnerLoginreducer.isLoginSuccess,
    isOtpSuccess: state.partnerLoginreducer.isOtpSuccess,
    resendOtpSuccess: state.partnerLoginreducer.resendOtpSuccess,
    // forgot side----------
    isVerifySuccess: state.partnerLoginreducer.isVerifySuccess,
    isValidatdOtpSuccess: state.partnerLoginreducer.isValidatdOtpSuccess,
    forgotResendOtpSuccess: state.partnerLoginreducer.forgotResendOtpSuccess,
    newPasswordSuccess: state.partnerLoginreducer.newPasswordSuccess,
  };
};

const mapDispatchToProps = (dispatch) => ({
  verifyPartnerLogin: (email, password) =>
    dispatch(verifyPartnerLogin(email, password)),
  partnerOtpVerify: (otp) => dispatch(partnerOtpVerify(otp)),
  partnerResendOtps: (email) => dispatch(partnerResendOtp(email)),

  verifyPartnerForgot: (forgotEmail) =>
    dispatch(verifyPartnerForgot(forgotEmail)),
