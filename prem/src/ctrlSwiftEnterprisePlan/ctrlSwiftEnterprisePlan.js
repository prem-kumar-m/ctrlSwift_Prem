...
class ctrlSwiftEnterprise extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      plan:"Enterprise",
...
//export default ctrlSwiftEnterprise;
ctrlSwiftEnterprise.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ctrlSwiftEnterprise);;
